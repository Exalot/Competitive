...
public class Graph<V> {
    ...
    public ArrayList<Edge> minimumDistance(V startIndex, V finishIndex) {
        ...
        Edge currentEdge = minimumDistanceMap.get(vertexMap.get(finishIndex)).previousEdge;
        Stack<Edge> stackx = new Stack<>();
        while (currentEdge != null) {
            stackx.add(currentEdge);
            currentEdge = minimumDistanceMap.get(currentEdge.start).previousEdge;
        }
    ...
    public static double getMinDistance(ArrayList<Graph<Integer>.Edge> path) {
